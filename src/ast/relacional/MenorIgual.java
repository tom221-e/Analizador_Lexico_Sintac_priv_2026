...
public class MenorIgual extends OperacionBinaria {
    ...
    protected String getNombreOperacion() {
        return "<="; // Corresponde a MENOR IGUAL
    }
    ...
    public String get_llvm_op_code() {
        ...
        if (this.tipo.matches("\\d+")) {
            return "10"; // Cambia este identificador por el número que use tu ALU para "<="
        }
    ...
    /**
     * Genera la instrucción de comparación relacional escalar para "Menor o Igual que".
    ...
    protected String obtenerCodigoEscalar() {
        ...
        // Formato Enteros:  %ptro.X = icmp sle i32 %ptro.A, %ptro.B
        // Formato Decimales: %ptro.Y = fcmp ole double %ptro.C, %ptro.D
